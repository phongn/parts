...
class TestPattern(unittest.TestCase):
    ...
    def test_pattern1(self):
        ...
        self.assertEqual(filelist,['pattern\\aaa.xml','pattern\\aaa\\aaa.xml'])
   ...
   #def test_pattern2(self):  #This fails because Pattern() returns absolute path instead of relative
        ...
        #self.assertEqual(filelist,['pattern\\aaa\\aaa.xml'])

    def test_pattern3(self):
        filelist = Pattern(src_dir='./pattern', includes=['*.xml','*.cpp']).files()
        self.assertEqual(filelist,['pattern\\aaa.xml','pattern\\bbb.cpp','pattern\\aaa\\aaa.xml'])
    ...
    def test_pattern5(self):
        ...
        self.assertEqual(filelist,['pattern\\aaa.xml','pattern\\bbb.cpp','pattern\\ddd.h','pattern\\aaa\\aaa.xml'])        

    def test_pattern6(self):
        filelist = Pattern(src_dir='./pattern', includes=['*.xml','*.cpp','*.h'], excludes=['.\\aaa\\*']).files()
        self.assertEqual(filelist,['pattern\\aaa.xml','pattern\\bbb.cpp','pattern\\ccc.h','pattern\\ddd.h'])        
    ...
    def test_pattern10(self):
        ...
        self.assertEqual(filelist,['pattern\\aaa.xml','pattern\\bbb.cpp','pattern\\ccc.h','pattern\\aaa\\aaa.xml'])        
    ...
    def test_pattern11(self): #Possible Bug : This Test Fails because excludes override includes and so it returns a empty list. Though I think such a situation is not unimaginable
        ...
        self.assertEqual(filelist,['pattern\\aaa.xml'])
