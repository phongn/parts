...
t.cmd="scons all --mode=foo --trace=mode_option --tc=null --console-stream=none"
t.returncode=0
t.streams.stdtrace='gold/mode_good1.gold'

t=test.AddTestRun("good")
t.cmd="scons all --trace=mode_option --tc=null --console-stream=none"
t.returncode=0
t.streams.stdtrace='gold/mode_good2.gold'

t=test.AddTestRun("good")
t.cmd="scons all --mode=foo,boo --trace=mode_option --tc=null --console-stream=none"
t.returncode=0
