...
##        self.assertEqual(relative_path,'product')
    ...
    def test_path4(self): #Possible Bug: it actually returns "\\" but I am giving it a Linux path
        relative_path = relpath('/opt/opt/opt/opt/opt/opt/opt/opt/opt/opt/opt/opt/opt/opt/opt/opt/product','/opt/opt/opt/opt/opt/opt/opt/opt/opt/opt/opt/opt/opt/opt/opt/')        
